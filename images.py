...
waves_img = pygame.image.load('waves_1.png').convert_alpha()
waves2_img = pygame.image.load('waves_2.png').convert_alpha()
waves3_img = pygame.image.load('waves_3.png').convert_alpha()
waves4_img = pygame.image.load('waves_4.png').convert_alpha()
...
#ocean_amb_music = pygame.mixer.Sound('ocean_amb.wav')